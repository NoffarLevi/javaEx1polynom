...
class ComplexFunctionTest {
	...
	void testComplexFunction() {
		...
		assertEquals("mul(2.0x^3+1.0x^1,4.0x^3+3.0x^2+-5.0x^1+-2.0x^0)", cf1.toString());
		assertEquals("div(9.0x^3+-4.0x^2+-5.0x^1,2.0x^3+12.0x^1+9.0x^0)", cf2.toString());
		assertEquals("2.0x^3+1.0x^1", cf3.toString());
	...
	void testInitFromString()
	{
		...
		assertEquals("-1.0x^4+2.0x^2+3.0x^0", cf.toString());
		assertEquals("1.0x^5+-1.0x^1+5.0x^0", cf1.toString());
		assertEquals("plus(-1.0x^4+2.5x^2+3.0x^0,plus(0.5x^5+-1.5x^1+5.0x^0,3.5x^4))", cf2.toString());
	...
	void testCopy() {
		...
		assertEquals("-1.0x^4+2.0x^2+3.0x^0", copy1.toString());
		assertEquals("div(1.0x^5+-1.0x^1+5.0x^0,mul(4.0x^4+4.0x^0,-6.0x^3))", copy2.toString());
		assertEquals("plus(-1.0x^4+2.5x^2+3.0x^0,plus(0.5x^5+-1.5x^1+5.0x^0,3.5x^4))", copy3.toString());
		
		cf1.max(cf2);
		assertEquals("div(1.0x^5+-1.0x^1+5.0x^0,mul(4.0x^4+4.0x^0,-6.0x^3))", copy2.toString());
		assertEquals("max(div(1.0x^5+-1.0x^1+5.0x^0,mul(4.0x^4+4.0x^0,-6.0x^3)),plus(-1.0x^4+2.5x^2+3.0x^0,plus(0.5x^5+-1.5x^1+5.0x^0,3.5x^4)))", cf1.toString());
	...
	void testToString() {
		...
		assertEquals("mul(-1.0x^4+2.5x^2+3.0x^0,0.5x^5+-1.5x^1+5.0x^0)" ,cf.toString());
		assertEquals("div(-1.0x^4+2.4x^2+3.1x^0,0.5x^5+-1.5x^1+5.0x^0)", cf1.toString());
		assertEquals("mul(plus(1.0x^1+1.0x^0,plus(mul(1.0x^1+3.0x^0,1.0x^1+-2.0x^0),1.0x^1+4.0x^0)),2.0x^0)", cf2.toString());
		assertEquals("-1.0x^4+2.0x^2+3.0x^0" ,cf3.toString());
		assertEquals("1.0x^5+-1.0x^1+5.0x^0", cf4.toString());
		assertEquals("plus(-1.0x^4+2.5x^2+3.0x^0,0.5x^5+-1.5x^1+5.0x^0)" ,cf5.toString());
